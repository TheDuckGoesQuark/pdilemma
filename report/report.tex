...
In order for the client to join a random game, an optional URL parameter was added to the GET request for all games that would allow the client to filter for 'available' games. Availability in this context is any game that can accept at least another prisoner.
